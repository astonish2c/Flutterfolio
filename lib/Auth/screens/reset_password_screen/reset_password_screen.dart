...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.transparent, elevation: 0, title: const Text('Password reset')),
      body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(label: Text('Email'), border: OutlineInputBorder(), prefixIcon: Icon(Icons.email_rounded)),
                autofocus: false,
