...
class _VerificationStateState extends State<VerificationState> {
  ...
  Widget build(BuildContext context) {
    return _isEmailVerified ? const NavigateScreen() : VerifyEmailScreen(sendVerificationEmail: sendEmailVerification, canSendEmailVerification: _canSendEmailVerification, remainingSeconds: _remainingSeconds);
  }
}
