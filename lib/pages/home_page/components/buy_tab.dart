...
import '/pages/home_page/utils/sell_tab_functins.dart';
...
class _BuyTabState extends State<BuyTab> with SellTabFunction {
  late TextEditingController _amountController, _priceController, _feeController, _noteController;
  late FocusNode _focusNode;

  late double _priceValue;
  bool _isPriceSet = false, _isFeeSet = false, _isNoteSet = false, _isDateSet = false;
