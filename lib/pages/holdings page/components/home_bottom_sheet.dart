...
class _HomeBottomSheetState extends State<HomeBottomSheet> {
  ...
  void _submit() {
    ...
    if (amountText.isEmpty || priceText.isEmpty) {
      ...
      coinModel.amount = double.parse(amountText);
      coinModel.buyPrice = double.parse(priceText);
      ...
      Provider.of<DataProvider>(context, listen: false).calculateTotalUserBalance();
            ...
            children: [
              TextButton(
                ...
                onPressed: () async {
                  ...
                  dateTime = await showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime(2011), lastDate: DateTime.now());
                  if (dateTime != null) {
                    setState(() {
                      _dateTime = dateTime;
                    });
