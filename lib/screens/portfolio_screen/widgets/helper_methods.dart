...
launchEmail() async {
  final Uri params = Uri(scheme: 'mailto', path: 'astonish2c@gmail.com', query: encodeQueryParameters(<String, String>{'subject': 'I encountered a bug in Flutter Crypto wallet app.'}));
  try {
