...
class PortfolioCoinSkeleton extends StatelessWidget {
  const PortfolioCoinSkeleton({required this.coin, super.key});
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Image.network(coin.image, width: 50, height: 50, errorBuilder: (context, error, stackTrace) => const CustomImage(imagePath: 'assets/images/no-wifi.png', size: 50)),
