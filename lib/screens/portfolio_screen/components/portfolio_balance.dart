  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        boxShadow: [BoxShadow(color: Colors.grey.withOpacity(0.4), blurRadius: 7)],
        color: theme.colorScheme.primaryContainer,
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('My Balance', textAlign: TextAlign.start, maxLines: 1, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodyMedium!.copyWith(fontSize: 16)),
          const SizedBox(height: 8),
          FittedBox(
            fit: BoxFit.scaleDown,
            child: Text(isSellMore ? '-$userBalanceSet' : userBalanceSet, maxLines: 1, style: theme.textTheme.titleLarge!.copyWith(fontSize: 32)),
          ),
          const SizedBox(height: 8),
        ],
      ),
