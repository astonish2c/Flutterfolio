...
class PortfolioCoinsSection extends StatefulWidget {
  const PortfolioCoinsSection({super.key});
...
class _PortfolioCoinsSectionState extends State<PortfolioCoinsSection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Row(children: [Text('My Portfolio', style: theme.textTheme.titleMedium!.copyWith(fontSize: 24))]),
            ...
            child: userCoins.isNotEmpty
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => TransactionsScreen(coin: localUserCoins[index])));
                        },
                      );
                    },
                  )
                : Column(
                    ...
                    children: [
                      ...
                      CustomRoundButton(title: 'Add transaction', onPressed: () => Navigator.of(context).pushNamed(AddCoinsScreen.routeName)),
                    ],
                  ),
          ),
        ],
