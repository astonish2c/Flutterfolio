...
class _PortfolioAppBarState extends State<PortfolioAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      centerTitle: true,
      title: Text('Flutterfolio', style: theme.textTheme.titleMedium!.copyWith(fontWeight: FontWeight.w700, letterSpacing: 1.2)),
      actions: [
        Consumer<ThemeProvider>(
          builder: (context, themeProvider, child) => GestureDetector(
            ...
            child: Padding(padding: const EdgeInsets.symmetric(horizontal: 16), child: _isDarkTheme ? const Icon(Icons.wb_sunny_rounded, size: 25) : const Icon(Icons.nightlight_round_rounded, size: 25)),
          ),
        ),
      ],
    );
