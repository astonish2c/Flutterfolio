...
class MarketPriceColumn extends StatelessWidget {
  const MarketPriceColumn({super.key, required this.coin});
    ...
    return Column(
      ...
      children: [
        FittedBox(
          ...
          child: Text(currencyConverter(coin.currentPrice, isCurrency: true), maxLines: 1, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.titleMedium),
        ),
