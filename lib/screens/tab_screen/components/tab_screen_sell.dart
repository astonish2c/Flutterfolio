...
class SellTab extends StatefulWidget {
  const SellTab({super.key, required this.coin, this.indexTransaction, this.isPushHomePage, required this.initialPage});
            ...
            builder: (context, value, child) => TextButton(
              ...
              onPressed: checkUserInput(value.text) || _isLoadingAdd
                  ...
                  : () async {
                      ...
                      await addOrUpdate(context: context, coin: widget.coin, amountController: _amountController, indexTransaction: widget.indexTransaction, isPushHomePage: widget.isPushHomePage, isSell: true, price: _price, selectedDate: _selectedDate);
                      setState(() {
                        _isLoadingAdd = false;
                      });
                    },
