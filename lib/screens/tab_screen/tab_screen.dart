      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: TabBarView(
            controller: _tabController,
            children: [
              BuyTab(coin: _coin, indexTransaction: _indexTransaction, isPushHomePage: _isPushHomePage, initialPage: _initialPage),
              SellTab(coin: _coin, indexTransaction: _indexTransaction, isPushHomePage: _isPushHomePage, initialPage: _initialPage),
            ],
          ),
        ),
      ),
