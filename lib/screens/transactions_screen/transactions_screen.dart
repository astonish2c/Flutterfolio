    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Consumer<ThemeProvider>(
          builder: (context, value, child) => CustomIconButton(icon: Icons.arrow_back_ios, onPressed: () => Navigator.of(context).pop()),
        ),
        title: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Image.network(widget.coin!.image, height: 25, width: 25, errorBuilder: (context, error, stackTrace) => const CustomImage(imagePath: 'assets/images/no-wifi.png', size: 25)),
            const SizedBox(width: 4),
            Text(widget.coin!.symbol.toUpperCase(), style: theme.textTheme.titleMedium!.copyWith(fontSize: 18)),
            const SizedBox(width: 4),
            Text(widget.coin!.name.toCapitalized(), style: theme.textTheme.bodyMedium),
          ],
        ),
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Transactions', style: theme.textTheme.titleMedium!.copyWith(fontSize: 22)),
