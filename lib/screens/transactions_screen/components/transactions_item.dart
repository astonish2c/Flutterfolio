...
class TransactionsItem extends StatelessWidget {
  const TransactionsItem({super.key, required this.coin, required this.transaction});
            ...
            children: [
              Consumer<ThemeProvider>(
                builder: (context, value, child) => Container(
                  ...
                  decoration: BoxDecoration(color: bgColorDay, shape: BoxShape.circle),
                  child: Icon(transaction.isSell ? Icons.arrow_upward : Icons.arrow_downward_rounded),
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(DateFormat('E, MMM d, y, h:m a').format(transaction.dateTime), textAlign: TextAlign.start, style: textTheme.bodySmall),
                    ),
                  ],
                ),
              ),
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(totalCost, style: textTheme.titleMedium),
                    Text(
                      totalAmount,
